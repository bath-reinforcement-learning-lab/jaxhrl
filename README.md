...
| [HierQ](jaxhrl/HierQ.py) | Levy et al., *"Learning Multi-Level Hierarchies with Hindsight"* (Algorithm 2, Appendix) | Verified — every mechanism Algorithm 2 specifies holds in the tables it writes (20/20). |
